# Adaptation A/B 實驗摘要：ab_20220601_20241231_top20_horizon5_top20_reb15_sched20_tw500
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| scheduled_20 | 32.0 | 41.423 | 14.845 | 0.747 | -22.106 | 54.36 | 0.065 | 9.78 | 3.347 | 6.432 | 14142277.35 | 0.0 | 0.0 |
| ew_buy_hold_universe | 0.0 | 43.612 | 15.552 | 1.054 | -13.907 | 58.95 | 0.002 | 6.196 | 0.023 | 6.173 | 14361204.23 | 0.0 | 0.0 |

## 觀察

- Sharpe 最高：`ew_buy_hold_universe` (1.054)；最低：`scheduled_20` (0.747)。
- 重訓次數範圍：0 → 32。
