# Adaptation A/B 實驗摘要：ab_20220601_20241231_top20_horizon5_top20_reb20_sched20_tw500
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| scheduled_20 | 32.0 | 34.456 | 12.551 | 0.632 | -22.739 | 55.94 | 0.051 | 8.562 | 2.823 | 5.738 | 13445593.82 | 0.0 | 0.0 |
| ew_buy_hold_universe | 0.0 | 43.612 | 15.552 | 1.054 | -13.907 | 58.95 | 0.002 | 6.196 | 0.023 | 6.173 | 14361204.23 | 0.0 | 0.0 |

## 觀察

- Sharpe 最高：`ew_buy_hold_universe` (1.054)；最低：`scheduled_20` (0.632)。
- 重訓次數範圍：0 → 32。
