# Adaptation A/B 實驗摘要：ab_20220601_20241231_top10_horizon5_reb5_none_tw500
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| none | 1.0 | -31.629 | -14.088 | -0.602 | -39.786 | 48.97 | 0.198 | 5.29 | 10.398 | -5.108 | 6837128.86 | 0.0 | 0.0 |
| ew_buy_hold_universe | 0.0 | 43.612 | 15.552 | 1.054 | -13.907 | 58.95 | 0.002 | 6.196 | 0.023 | 6.173 | 14361204.23 | 0.0 | 0.0 |

## 觀察

- Sharpe 最高：`ew_buy_hold_universe` (1.054)；最低：`none` (-0.602)。
- 重訓次數範圍：0 → 1。
