# Adaptation A/B 實驗摘要：ab_20220601_20241231_top10_horizon5_top10_reb10_model_pool_tw500
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| model_pool | 24.0 | -1.248 | -0.5 | 0.109 | -34.157 | 55.31 | 0.097 | 6.467 | 5.355 | 1.112 | 9875221.09 | 0.0 | 23.0 |
| ew_buy_hold_universe | 0.0 | 43.612 | 15.552 | 1.054 | -13.907 | 58.95 | 0.002 | 6.196 | 0.023 | 6.173 | 14361204.23 | 0.0 | 0.0 |

## 觀察

- Sharpe 最高：`ew_buy_hold_universe` (1.054)；最低：`model_pool` (0.109)。
- 重訓次數範圍：0 → 24。
